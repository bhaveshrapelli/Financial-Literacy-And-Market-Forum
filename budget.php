...
<body>
  ...
  <header class="d-flex align-items-center">
    ...
    <div class="img-container">
      <img
        src="https://lh3.googleusercontent.com/_bcUDu81MAIbqUu37rUXX2KZQ893b1EJQ5TYSeTDgOol5XH44vI68UvZg_25_-OwsagcJhxQmbGmpNLfHiomwLS9fcQbEw7ZNvKPZoWgROMzkS9xyh_tP4NlXy0Gc9cIAvuYCauivXw=w600-h315-p-k"
        id="heroimage" />
  ...
  <div class="nicecontainer container-fluid">
    ...
    <br>
    <div class="container">
      <h2>Personal finance is everything in your life that involes money. Arranging to spend, save, and invest money to
        live comfortably, have financial security, and acheive goals.</h2>
    </div>
    <br>
    ...
    <div class="row .row-eq-height">
      ...
      <div class="col-md-4">
        <div class="nicecontainer">
          ...
          <hr>
          <p>Understand to how to effectively save money for short and long term financial goals to obtain financial
            independence</p>
  ...
  <section class="sponsor" id="section-1">
    ...
    <div class="row nicecontainer colorblue">
      ...
      <div class="col-md-3">
        ...
        <p class="FPSubheadings">To develop clear financial goals, think about your attitude toward money and ask
          yourself some questions:</p>
        <div id="subheadingbullet">
          <ul class="bullet">
      ...
      <div class="col-md-3">
        ...
        <p class="FPSubheadings">It is impossible to make a good decision unless you know all your options. If you save
          $50 a month, here are some options you have:</p>
        <div id="subheadingbullet">
          <ul class="bullet">
      ...
      <div class="col-md-3">
        ...
        <div id="subheadingbullet">
          <ul class="bullet">
            <li>Using the many available sources of financial information to keep you up-to-daye with social and
              economic conditions that can affect your financial situation</li>
      ...
      <div class="col-md-6">
        ...
        <p class="FPSubheadings">As you get older, your finances and needs will change. That means that your financial
          plan will have to change too. You should reevaluate and revise it every year.</p>
      </div>
  ...
  <section class="sponsor" id="section-2">
    ...
    <div class="row nicecontainer coloryellow">
      ...
      <div class="col-md-3">
        ...
        <p>Services and goods are two different categories of financial needs. A haircut is an example of a a service,
          while a new car is a good.</p>
  ...
  <section class="sponsor" id="section-3">
    ...
    <div class="row nicecontainer colorred">
      <div class="col-md-4">
        ...
        <p>You can design a plan on your own, or use a good-money management mobile app. Making sure your financial plan
          work takes times, effort, and patience, but you will develop habits that will give you a lifetime of
  ...
  <section class="container">
    ...
    <div class="row nicecontainer">
      <div class="col-md-12">
        ...
        <a href="financial_calculator-master/docs/index.php"><button type="button"
            class="btn btn-success">Budget</button></a>
        <br>
      </div>
